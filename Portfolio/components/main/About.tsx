...
const About = () => {
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center justify-start relative md:mt-[90px] lg:mt-12 z-[20] w-auto h-auto">
                <InView triggerOnce={false}>
                    {({ inView, ref }) => (
                        ...
                        >
                            <img src="/karan.png" alt="profile" width={250} />
                        </motion.div>
                    )}
                </InView>
            ...
            <div className="w-full hidden md:flex items-start justify-center absolute top-[1px] -z-20 pointer-events-none opacity-40">
                <video
                    loop
                    muted
                    autoPlay
